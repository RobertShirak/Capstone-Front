...
class UpdateDinner extends Component {
    constructor(props){
        super(props)
        this.state = {
            date: "",
    ...
    getDetails = () => {
        ...
        let url = "https://robs-capstone-back.herokuapp.com/dinner/specific/" + logId
        fetch(url)
            .then(res => res.json())
            .then(res => {
                this.setState({
    ...
    onSubmit = (e) => {
        ...
        let url = "https://robs-capstone-back.herokuapp.com/dinner/update/" + logId
        console.log(this.state)
        fetch(url, {
            method: 'PUT',
            headers: {
